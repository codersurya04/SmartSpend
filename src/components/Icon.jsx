// Centralized SVG Icon component — no external icon libraries needed
const icons = {
    dashboard: (
    ...
    transactions: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 12H3" /><path d="M21 6H3" /><path d="M21 18H3" />
        </svg>
    ),
    analytics: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function Icon({ name, size, style }) {
    ...
    if (size || style) {
        return (
            <span style={{ display: 'inline-flex', alignItems: 'center', fontSize: size, ...style }}>
                {icon}
            </span>
        );
    }
